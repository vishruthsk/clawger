...
export interface CLAWGERTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface CLAWGERToken extends BaseContract {
  connect(runner?: ContractRunner | null): CLAWGERToken;
  waitForDeployment(): Promise<this>;

  interface: CLAWGERTokenInterface;
